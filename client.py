...
def download_video_client(video_url: str, output_dir: str, api_base_url: str = "http://127.0.0.1:9000/api/v1/video"):
    """
    ...
    try:
        ...
        response = requests.post(download_endpoint, json={"url": video_url}, stream=True)
...
if __name__ == "__main__":
    ...
    success = download_video_client(args.video_url, args.output_dir, api_base)
    if success:
